...
set_property PACKAGE_PIN U9 [get_ports {reset_i}]					
...
set_property PACKAGE_PIN U6 [get_ports {regs[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[7]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
set_property PACKAGE_PIN V4 [get_ports {regs[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[8]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
set_property PACKAGE_PIN U3 [get_ports {regs[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[9]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN V1 [get_ports {regs[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[10]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN R1 [get_ports {regs[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[11]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN P5 [get_ports {regs[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[12]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {regs[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[13]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {regs[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[14]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {regs[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regs[15]}]
...
set_property PACKAGE_PIN L3 [get_ports {strings[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[6]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {strings[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {strings[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {strings[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {strings[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {strings[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {strings[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[0]}]
...
set_property PACKAGE_PIN N6 [get_ports {strings[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {strings[7]}]
